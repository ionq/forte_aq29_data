...
qreg q[25];
creg c[25];
u3(pi/2,3.141592652803582,-pi) q[0];
u3(pi/2,-1.5707963271880023,-pi) q[1];
u3(pi/2,-0.7853981635940013,-pi) q[2];
u3(pi/2,-0.39269908179700064,-pi) q[3];
u3(pi/2,-0.19634954089850032,-pi) q[4];
u3(pi/2,-0.09817477044924994,-pi) q[5];
u3(pi/2,3.0925052683651684,-pi) q[6];
u3(pi/2,1.5462526341825846,-pi) q[7];
u3(pi/2,-2.368466336498501,-pi) q[8];
u3(pi/2,1.9573594853405432,-pi) q[9];
u3(pi/2,0.9786797426702716,-pi) q[10];
u3(pi/2,-2.6522527822546573,-pi) q[11];
u3(pi/2,1.815466262462465,-pi) q[12];
u3(pi/2,-2.2338595223585607,-pi) q[13];
u3(pi/2,-1.1169297611792803,-pi) q[14];
u3(pi/2,-0.5584648805896402,-pi) q[15];
u3(pi/2,-0.27923244029481964,-pi) q[16];
u3(pi/2,3.0019764334423833,-pi) q[17];
u3(pi/2,-1.6406044368686015,-pi) q[18];
u3(pi/2,-0.8203022184343007,-pi) q[19];
u3(pi/2,-0.41015110921715037,-pi) q[20];
u3(pi/2,-0.20507555460857496,-pi) q[21];
u3(pi/2,3.0390548762855056,-pi) q[22];
u3(pi/2,1.5195274381427524,-pi) q[23];
u3(-pi,-pi/2,pi/2) q[24];
cx q[23],q[24];
u3(0,0,-1.51952743814275) q[24];
cx q[23],q[24];
u3(0,0,-1.87253514146196e-7) q[23];
u3(0,0,1.51952743814275) q[24];
cx q[22],q[24];
u3(0,0,-3.03905487628551) q[24];
cx q[22],q[24];
u3(0,0,-3.74507028292393e-7) q[22];
u3(0,0,3.03905487628551) q[24];
cx q[21],q[24];
u3(0,0,-6.07810975257101) q[24];
cx q[21],q[24];
u3(0,0,-7.49014056584786e-7) q[21];
u3(0,0,6.07810975257101) q[24];
cx q[20],q[24];
u3(0,0,-12.156219505142) q[24];
cx q[20],q[24];
u3(0,0,-1.49802811316957e-6) q[20];
u3(0,0,12.156219505142) q[24];
cx q[19],q[24];
u3(0,0,-24.312439010284) q[24];
cx q[19],q[24];
u3(0,0,-2.99605622633914e-6) q[19];
u3(0,0,24.312439010284) q[24];
cx q[18],q[24];
u3(0,0,-48.6248780205681) q[24];
cx q[18],q[24];
u3(0,0,-5.99211245267829e-6) q[18];
u3(0,0,48.6248780205681) q[24];
cx q[17],q[24];
u3(0,0,-97.2497560411362) q[24];
cx q[17],q[24];
u3(0,0,-1.19842249053566e-5) q[17];
u3(0,0,97.2497560411362) q[24];
cx q[16],q[24];
u3(0,0,-194.499512082272) q[24];
cx q[16],q[24];
u3(0,0,-2.39684498107131e-5) q[16];
u3(0,0,194.499512082272) q[24];
cx q[15],q[24];
u3(0,0,-388.999024164545) q[24];
cx q[15],q[24];
u3(0,0,-4.79368996214263e-5) q[15];
u3(0,0,388.999024164545) q[24];
cx q[14],q[24];
u3(0,0,-777.998048329089) q[24];
cx q[14],q[24];
u3(0,0,-9.58737992428526e-5) q[14];
u3(0,0,777.998048329089) q[24];
cx q[13],q[24];
u3(0,0,-1555.99609665818) q[24];
cx q[13],q[24];
u3(0,0,-0.000191747598485705) q[13];
u3(0,0,1555.99609665818) q[24];
cx q[12],q[24];
u3(0,0,-3111.99219331636) q[24];
cx q[12],q[24];
u3(0,0,-0.00038349519697141) q[12];
u3(0,0,3111.99219331636) q[24];
cx q[11],q[24];
u3(0,0,-6223.98438663272) q[24];
cx q[11],q[24];
u3(0,0,-0.000766990393942821) q[11];
u3(0,0,6223.98438663272) q[24];
cx q[10],q[24];
u3(0,0,-12447.9687732654) q[24];
cx q[10],q[24];
u3(0,0,-0.00153398078788564) q[10];
u3(0,0,12447.9687732654) q[24];
cx q[9],q[24];
u3(0,0,-24895.9375465309) q[24];
cx q[9],q[24];
u3(0,0,24895.9375465309) q[24];
cx q[8],q[24];
u3(0,0,-49791.8750930617) q[24];
cx q[8],q[24];
u3(0,0,49791.8750930617) q[24];
cx q[7],q[24];
u3(0,0,-99583.7501861234) q[24];
cx q[7],q[24];
u3(0,0,99583.7501861234) q[24];
cx q[6],q[24];
u3(0,0,-199167.500372247) q[24];
cx q[6],q[24];
u3(0,0,199167.500372247) q[24];
cx q[5],q[24];
u3(0,0,-398335.000744494) q[24];
cx q[5],q[24];
u3(0,0,398335.000744494) q[24];
cx q[4],q[24];
u3(0,0,-796670.001488988) q[24];
cx q[4],q[24];
u3(0,0,796670.001488988) q[24];
cx q[3],q[24];
u3(0,0,-1593340.00297798) q[24];
cx q[3],q[24];
u3(0,0,1593340.00297798) q[24];
cx q[2],q[24];
u3(0,0,-3186680.00595595) q[24];
cx q[2],q[24];
u3(0,0,-pi/8) q[2];
u3(0,0,3186680.00595595) q[24];
cx q[1],q[24];
u3(0,0,-6373360.0119119) q[24];
cx q[1],q[24];
u3(0,0,-pi/4) q[1];
u3(0,0,6373360.0119119) q[24];
cx q[0],q[24];
u3(0,0,-12746720.0238238) q[24];
cx q[0],q[24];
u3(pi/2,0,-pi) q[0];
cx q[0],q[1];
u3(0,0,pi/4) q[1];
