...
qreg q[19];
creg c[19];
u3(pi/2,3.141592653548689,-pi) q[0];
u3(pi/2,-1.5707963268154481,-pi) q[1];
u3(pi/2,-0.7853981634077245,-pi) q[2];
u3(pi/2,2.7488935718859313,-pi) q[3];
u3(pi/2,-1.7671458676468275,-pi) q[4];
u3(pi/2,-0.8835729338234142,-pi) q[5];
u3(pi/2,2.699806186678087,-pi) q[6];
u3(pi/2,1.3499030933390435,-pi) q[7];
u3(pi/2,0.6749515466695213,-pi) q[8];
u3(pi/2,0.3374757733347611,-pi) q[9];
u3(pi/2,0.16873788666738054,-pi) q[10];
u3(pi/2,-3.057223710256103,-pi) q[11];
u3(pi/2,-1.5286118551280514,-pi) q[12];
u3(pi/2,-0.7643059275640258,-pi) q[13];
u3(pi/2,2.75943968980778,-pi) q[14];
u3(pi/2,-1.7618728086859026,-pi) q[15];
u3(pi/2,-0.8809364043429513,-pi) q[16];
u3(pi/2,2.701124451418318,-pi) q[17];
u3(-pi,-pi/2,pi/2) q[18];
cx q[17],q[18];
u3(0,0,-2.70112445141832) q[18];
cx q[17],q[18];
u3(0,0,-1.19842249053566e-5) q[17];
u3(0,0,2.70112445141832) q[18];
cx q[16],q[18];
u3(0,0,-5.40224890283663) q[18];
cx q[16],q[18];
u3(0,0,-2.39684498107131e-5) q[16];
u3(0,0,5.40224890283663) q[18];
cx q[15],q[18];
u3(0,0,-10.8044978056733) q[18];
cx q[15],q[18];
u3(0,0,-4.79368996214263e-5) q[15];
u3(0,0,10.8044978056733) q[18];
cx q[14],q[18];
u3(0,0,-21.6089956113465) q[18];
cx q[14],q[18];
u3(0,0,-9.58737992428526e-5) q[14];
u3(0,0,21.6089956113465) q[18];
cx q[13],q[18];
u3(0,0,-43.2179912226931) q[18];
cx q[13],q[18];
u3(0,0,-0.000191747598485705) q[13];
u3(0,0,43.2179912226931) q[18];
cx q[12],q[18];
u3(0,0,-86.4359824453862) q[18];
cx q[12],q[18];
u3(0,0,-0.00038349519697141) q[12];
u3(0,0,86.4359824453862) q[18];
cx q[11],q[18];
u3(0,0,-172.871964890772) q[18];
cx q[11],q[18];
u3(0,0,-0.000766990393942821) q[11];
u3(0,0,172.871964890772) q[18];
cx q[10],q[18];
u3(0,0,-345.743929781545) q[18];
cx q[10],q[18];
u3(0,0,-0.00153398078788564) q[10];
u3(0,0,345.743929781545) q[18];
cx q[9],q[18];
u3(0,0,-691.487859563089) q[18];
cx q[9],q[18];
u3(0,0,691.487859563089) q[18];
cx q[8],q[18];
u3(0,0,-1382.97571912618) q[18];
cx q[8],q[18];
u3(0,0,1382.97571912618) q[18];
cx q[7],q[18];
u3(0,0,-2765.95143825236) q[18];
cx q[7],q[18];
u3(0,0,2765.95143825236) q[18];
cx q[6],q[18];
u3(0,0,-5531.90287650471) q[18];
cx q[6],q[18];
u3(0,0,5531.90287650471) q[18];
cx q[5],q[18];
u3(0,0,-11063.8057530094) q[18];
cx q[5],q[18];
u3(0,0,11063.8057530094) q[18];
cx q[4],q[18];
u3(0,0,-22127.6115060189) q[18];
cx q[4],q[18];
u3(0,0,22127.6115060189) q[18];
cx q[3],q[18];
u3(0,0,-44255.2230120377) q[18];
cx q[3],q[18];
u3(0,0,44255.2230120377) q[18];
cx q[2],q[18];
u3(0,0,-88510.4460240754) q[18];
cx q[2],q[18];
u3(0,0,88510.4460240754) q[18];
cx q[1],q[18];
u3(0,0,-177020.892048151) q[18];
cx q[1],q[18];
u3(0,0,-pi/4) q[1];
u3(0,0,177020.892048151) q[18];
cx q[0],q[18];
u3(0,0,-354041.784096302) q[18];
cx q[0],q[18];
u3(pi/2,0,-pi) q[0];
cx q[0],q[1];
u3(0,0,pi/4) q[1];
