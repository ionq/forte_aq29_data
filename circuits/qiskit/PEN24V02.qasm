...
qreg q[24];
creg c[24];
u3(pi/2,3.141592652952647,-pi) q[0];
u3(pi/2,1.5707963264763238,-pi) q[1];
u3(pi/2,-2.356194490351631,-pi) q[2];
u3(pi/2,-1.1780972451758158,-pi) q[3];
u3(pi/2,-0.5890486225879079,-pi) q[4];
u3(pi/2,2.84706834229584,-pi) q[5];
u3(pi/2,-1.7180584824418732,-pi) q[6];
u3(pi/2,-0.8590292412209366,-pi) q[7];
u3(pi/2,2.712078032979325,-pi) q[8];
u3(pi/2,1.356039016489662,-pi) q[9];
u3(pi/2,0.6780195082448315,-pi) q[10];
u3(pi/2,-2.8025828994673776,-pi) q[11];
u3(pi/2,1.740301203856105,-pi) q[12];
u3(pi/2,0.870150601928052,-pi) q[13];
u3(pi/2,-2.706517352625767,-pi) q[14];
u3(pi/2,-1.3532586763128833,-pi) q[15];
u3(pi/2,-0.6766293381564417,-pi) q[16];
u3(pi/2,2.8032779845115723,-pi) q[17];
u3(pi/2,-1.739953661334007,-pi) q[18];
u3(pi/2,-0.869976830667003,-pi) q[19];
u3(pi/2,-0.4349884153335015,-pi) q[20];
u3(pi/2,2.9240984459230424,-pi) q[21];
u3(pi/2,1.4620492229615216,-pi) q[22];
u3(-pi,-pi/2,pi/2) q[23];
cx q[22],q[23];
u3(0,0,-1.46204922296152) q[23];
cx q[22],q[23];
u3(0,0,-3.74507028292393e-7) q[22];
u3(0,0,1.46204922296152) q[23];
cx q[21],q[23];
u3(0,0,-2.92409844592304) q[23];
cx q[21],q[23];
u3(0,0,-7.49014056584786e-7) q[21];
u3(0,0,2.92409844592304) q[23];
cx q[20],q[23];
u3(0,0,-5.84819689184608) q[23];
cx q[20],q[23];
u3(0,0,-1.49802811316957e-6) q[20];
u3(0,0,5.84819689184608) q[23];
cx q[19],q[23];
u3(0,0,-11.6963937836922) q[23];
cx q[19],q[23];
u3(0,0,-2.99605622633914e-6) q[19];
u3(0,0,11.6963937836922) q[23];
cx q[18],q[23];
u3(0,0,-23.3927875673843) q[23];
cx q[18],q[23];
u3(0,0,-5.99211245267829e-6) q[18];
u3(0,0,23.3927875673843) q[23];
cx q[17],q[23];
u3(0,0,-46.7855751347687) q[23];
cx q[17],q[23];
u3(0,0,-1.19842249053566e-5) q[17];
u3(0,0,46.7855751347687) q[23];
cx q[16],q[23];
u3(0,0,-93.5711502695374) q[23];
cx q[16],q[23];
u3(0,0,-2.39684498107131e-5) q[16];
u3(0,0,93.5711502695374) q[23];
cx q[15],q[23];
u3(0,0,-187.142300539075) q[23];
cx q[15],q[23];
u3(0,0,-4.79368996214263e-5) q[15];
u3(0,0,187.142300539075) q[23];
cx q[14],q[23];
u3(0,0,-374.284601078149) q[23];
cx q[14],q[23];
u3(0,0,-9.58737992428526e-5) q[14];
u3(0,0,374.284601078149) q[23];
cx q[13],q[23];
u3(0,0,-748.569202156299) q[23];
cx q[13],q[23];
u3(0,0,-0.000191747598485705) q[13];
u3(0,0,748.569202156299) q[23];
cx q[12],q[23];
u3(0,0,-1497.1384043126) q[23];
cx q[12],q[23];
u3(0,0,-0.00038349519697141) q[12];
u3(0,0,1497.1384043126) q[23];
cx q[11],q[23];
u3(0,0,-2994.2768086252) q[23];
cx q[11],q[23];
u3(0,0,-0.000766990393942821) q[11];
u3(0,0,2994.2768086252) q[23];
cx q[10],q[23];
u3(0,0,-5988.55361725039) q[23];
cx q[10],q[23];
u3(0,0,-0.00153398078788564) q[10];
u3(0,0,5988.55361725039) q[23];
cx q[9],q[23];
u3(0,0,-11977.1072345008) q[23];
cx q[9],q[23];
u3(0,0,11977.1072345008) q[23];
cx q[8],q[23];
u3(0,0,-23954.2144690016) q[23];
cx q[8],q[23];
u3(0,0,23954.2144690016) q[23];
cx q[7],q[23];
u3(0,0,-47908.4289380031) q[23];
cx q[7],q[23];
u3(0,0,47908.4289380031) q[23];
cx q[6],q[23];
u3(0,0,-95816.8578760063) q[23];
cx q[6],q[23];
u3(0,0,95816.8578760063) q[23];
cx q[5],q[23];
u3(0,0,-191633.715752013) q[23];
cx q[5],q[23];
u3(0,0,191633.715752013) q[23];
cx q[4],q[23];
u3(0,0,-383267.431504025) q[23];
cx q[4],q[23];
u3(0,0,383267.431504025) q[23];
cx q[3],q[23];
u3(0,0,-766534.86300805) q[23];
cx q[3],q[23];
u3(0,0,766534.86300805) q[23];
cx q[2],q[23];
u3(0,0,-1533069.7260161) q[23];
cx q[2],q[23];
u3(0,0,-pi/8) q[2];
u3(0,0,1533069.7260161) q[23];
cx q[1],q[23];
u3(0,0,-3066139.4520322) q[23];
cx q[1],q[23];
u3(0,0,-pi/4) q[1];
u3(0,0,3066139.4520322) q[23];
cx q[0],q[23];
u3(0,0,-6132278.9040644) q[23];
cx q[0],q[23];
u3(pi/2,0,-pi) q[0];
cx q[0],q[1];
u3(0,0,pi/4) q[1];
