...
qreg q[30];
creg c[30];
u3(pi/2,-7.160560944186045e-08,-pi) q[0];
u3(pi/2,3.141592617786989,-pi) q[1];
u3(pi/2,1.5707963088934944,-pi) q[2];
u3(pi/2,-2.3561944991430464,-pi) q[3];
u3(pi/2,1.9634954040182704,-pi) q[4];
u3(pi/2,-2.1598449515806584,-pi) q[5];
u3(pi/2,-1.0799224757903296,-pi) q[6];
u3(pi/2,2.6016314156946283,-pi) q[7];
u3(pi/2,1.3008157078473142,-pi) q[8];
u3(pi/2,0.6504078539236575,-pi) q[9];
u3(pi/2,-2.816388726627965,-pi) q[10];
u3(pi/2,-1.408194363313982,-pi) q[11];
u3(pi/2,-0.7040971816569912,-pi) q[12];
u3(pi/2,2.7895440627612977,-pi) q[13];
u3(pi/2,-1.7468206222091442,-pi) q[14];
u3(pi/2,-0.8734103111045721,-pi) q[15];
u3(pi/2,-0.43670515555228606,-pi) q[16];
u3(pi/2,-0.2183525777761428,-pi) q[17];
u3(pi/2,-0.1091762888880714,-pi) q[18];
u3(pi/2,-0.05458814444403526,-pi) q[19];
u3(pi/2,3.114298581367775,-pi) q[20];
u3(pi/2,-1.5844433629059054,-pi) q[21];
u3(pi/2,2.3493709721368408,-pi) q[22];
u3(pi/2,-1.9669071675213727,-pi) q[23];
u3(pi/2,-0.9834535837606868,-pi) q[24];
u3(pi/2,-0.4917267918803434,-pi) q[25];
u3(pi/2,2.895729257649622,-pi) q[26];
u3(pi/2,-1.6937280247649822,-pi) q[27];
u3(pi/2,2.2947286412073016,-pi) q[28];
u3(-pi,-pi/2,pi/2) q[29];
cx q[28],q[29];
u3(0,0,-2.2947286412073) q[29];
cx q[28],q[29];
u3(0,0,-5.85167231706864e-9) q[28];
u3(0,0,2.2947286412073) q[29];
cx q[27],q[29];
u3(0,0,-4.5894572824146) q[29];
cx q[27],q[29];
u3(0,0,-1.17033446341373e-8) q[27];
u3(0,0,4.5894572824146) q[29];
cx q[26],q[29];
u3(0,0,-9.17891456482921) q[29];
cx q[26],q[29];
u3(0,0,-2.34066892682746e-8) q[26];
u3(0,0,9.17891456482921) q[29];
cx q[25],q[29];
u3(0,0,-18.3578291296584) q[29];
cx q[25],q[29];
u3(0,0,-4.68133785365491e-8) q[25];
u3(0,0,18.3578291296584) q[29];
cx q[24],q[29];
u3(0,0,-36.7156582593168) q[29];
cx q[24],q[29];
u3(0,0,-9.36267570730982e-8) q[24];
u3(0,0,36.7156582593168) q[29];
cx q[23],q[29];
u3(0,0,-73.4313165186337) q[29];
cx q[23],q[29];
u3(0,0,-1.87253514146196e-7) q[23];
u3(0,0,73.4313165186337) q[29];
cx q[22],q[29];
u3(0,0,-146.862633037267) q[29];
cx q[22],q[29];
u3(0,0,-3.74507028292393e-7) q[22];
u3(0,0,146.862633037267) q[29];
cx q[21],q[29];
u3(0,0,-293.725266074535) q[29];
cx q[21],q[29];
u3(0,0,-7.49014056584786e-7) q[21];
u3(0,0,293.725266074535) q[29];
cx q[20],q[29];
u3(0,0,-587.450532149069) q[29];
cx q[20],q[29];
u3(0,0,-1.49802811316957e-6) q[20];
u3(0,0,587.450532149069) q[29];
cx q[19],q[29];
u3(0,0,-1174.90106429814) q[29];
cx q[19],q[29];
u3(0,0,-2.99605622633914e-6) q[19];
u3(0,0,1174.90106429814) q[29];
cx q[18],q[29];
u3(0,0,-2349.80212859628) q[29];
cx q[18],q[29];
u3(0,0,-5.99211245267829e-6) q[18];
u3(0,0,2349.80212859628) q[29];
cx q[17],q[29];
u3(0,0,-4699.60425719255) q[29];
cx q[17],q[29];
u3(0,0,-1.19842249053566e-5) q[17];
u3(0,0,4699.60425719255) q[29];
cx q[16],q[29];
u3(0,0,-9399.20851438511) q[29];
cx q[16],q[29];
u3(0,0,-2.39684498107131e-5) q[16];
u3(0,0,9399.20851438511) q[29];
cx q[15],q[29];
u3(0,0,-18798.4170287702) q[29];
cx q[15],q[29];
u3(0,0,-4.79368996214263e-5) q[15];
u3(0,0,18798.4170287702) q[29];
cx q[14],q[29];
u3(0,0,-37596.8340575404) q[29];
cx q[14],q[29];
u3(0,0,-9.58737992428526e-5) q[14];
u3(0,0,37596.8340575404) q[29];
cx q[13],q[29];
u3(0,0,-75193.6681150809) q[29];
cx q[13],q[29];
u3(0,0,-0.000191747598485705) q[13];
u3(0,0,75193.6681150809) q[29];
cx q[12],q[29];
u3(0,0,-150387.336230162) q[29];
cx q[12],q[29];
u3(0,0,-0.00038349519697141) q[12];
u3(0,0,150387.336230162) q[29];
cx q[11],q[29];
u3(0,0,-300774.672460323) q[29];
cx q[11],q[29];
u3(0,0,-0.000766990393942821) q[11];
u3(0,0,300774.672460323) q[29];
cx q[10],q[29];
u3(0,0,-601549.344920647) q[29];
cx q[10],q[29];
u3(0,0,-0.00153398078788564) q[10];
u3(0,0,601549.344920647) q[29];
cx q[9],q[29];
u3(0,0,-1203098.68984129) q[29];
cx q[9],q[29];
u3(0,0,1203098.68984129) q[29];
cx q[8],q[29];
u3(0,0,-2406197.37968259) q[29];
cx q[8],q[29];
u3(0,0,2406197.37968259) q[29];
cx q[7],q[29];
u3(0,0,-4812394.75936518) q[29];
cx q[7],q[29];
u3(0,0,4812394.75936518) q[29];
cx q[6],q[29];
u3(0,0,-9624789.51873035) q[29];
cx q[6],q[29];
u3(0,0,9624789.51873035) q[29];
cx q[5],q[29];
u3(0,0,-19249579.0374607) q[29];
cx q[5],q[29];
u3(0,0,19249579.0374607) q[29];
cx q[4],q[29];
u3(0,0,-38499158.0749214) q[29];
cx q[4],q[29];
u3(0,0,38499158.0749214) q[29];
cx q[3],q[29];
u3(0,0,-76998316.1498428) q[29];
cx q[3],q[29];
u3(0,0,76998316.1498428) q[29];
cx q[2],q[29];
u3(0,0,-153996632.299686) q[29];
cx q[2],q[29];
u3(0,0,-pi/8) q[2];
u3(0,0,153996632.299686) q[29];
cx q[1],q[29];
u3(0,0,-307993264.599371) q[29];
cx q[1],q[29];
u3(0,0,-pi/4) q[1];
u3(0,0,307993264.599371) q[29];
cx q[0],q[29];
u3(0,0,-615986529.198743) q[29];
cx q[0],q[29];
u3(pi/2,0,-pi) q[0];
cx q[0],q[1];
u3(0,0,pi/4) q[1];
