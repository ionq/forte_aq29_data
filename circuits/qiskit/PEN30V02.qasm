...
qreg q[30];
creg c[30];
u3(pi/2,1.5659207264206998e-10,-pi) q[0];
u3(pi/2,7.829603632103499e-11,-pi) q[1];
u3(pi/2,3.914779611591257e-11,-pi) q[2];
u3(pi/2,1.957412010256121e-11,-pi) q[3];
u3(pi/2,9.78683800667568e-12,-pi) q[4];
u3(pi/2,-3.1415926535848993,-pi) q[5];
u3(pi/2,-1.5707963267924496,-pi) q[6];
u3(pi/2,-0.7853981633962248,-pi) q[7];
u3(pi/2,7*pi/8,-pi) q[8];
u3(pi/2,7*pi/16,-pi) q[9];
u3(pi/2,-2.454369260616873,-pi) q[10];
u3(pi/2,-1.2271846303084364,-pi) q[11];
u3(pi/2,2.528000338435575,-pi) q[12];
u3(pi/2,1.2640001692177876,-pi) q[13];
u3(pi/2,0.6320000846088938,-pi) q[14];
u3(pi/2,-2.8255926112853462,-pi) q[15];
u3(pi/2,-1.4127963056426731,-pi) q[16];
u3(pi/2,-0.7063981528213366,-pi) q[17];
u3(pi/2,-0.35319907641066806,-pi) q[18];
u3(pi/2,2.964993115384459,-pi) q[19];
u3(pi/2,-1.6590960958975636,-pi) q[20];
u3(pi/2,2.3120446056410113,-pi) q[21];
u3(pi/2,-1.9855703507692875,-pi) q[22];
u3(pi/2,-0.9927851753846433,-pi) q[23];
u3(pi/2,-0.49639258769232164,-pi) q[24];
u3(pi/2,2.8933963597436323,-pi) q[25];
u3(pi/2,1.4466981798718157,-pi) q[26];
u3(pi/2,0.7233490899359083,-pi) q[27];
u3(pi/2,0.36167454496795415,-pi) q[28];
u3(-pi,-pi/2,pi/2) q[29];
cx q[28],q[29];
u3(0,0,-0.361674544967954) q[29];
cx q[28],q[29];
u3(0,0,-5.85167231706864e-9) q[28];
u3(0,0,0.361674544967954) q[29];
cx q[27],q[29];
u3(0,0,-0.723349089935908) q[29];
cx q[27],q[29];
u3(0,0,-1.17033446341373e-8) q[27];
u3(0,0,0.723349089935908) q[29];
cx q[26],q[29];
u3(0,0,-1.44669817987182) q[29];
cx q[26],q[29];
u3(0,0,-2.34066892682746e-8) q[26];
u3(0,0,1.44669817987182) q[29];
cx q[25],q[29];
u3(0,0,-2.89339635974363) q[29];
cx q[25],q[29];
u3(0,0,-4.68133785365491e-8) q[25];
u3(0,0,2.89339635974363) q[29];
cx q[24],q[29];
u3(0,0,-5.78679271948726) q[29];
cx q[24],q[29];
u3(0,0,-9.36267570730982e-8) q[24];
u3(0,0,5.78679271948726) q[29];
cx q[23],q[29];
u3(0,0,-11.5735854389745) q[29];
cx q[23],q[29];
u3(0,0,-1.87253514146196e-7) q[23];
u3(0,0,11.5735854389745) q[29];
cx q[22],q[29];
u3(0,0,-23.1471708779491) q[29];
cx q[22],q[29];
u3(0,0,-3.74507028292393e-7) q[22];
u3(0,0,23.1471708779491) q[29];
cx q[21],q[29];
u3(0,0,-46.2943417558981) q[29];
cx q[21],q[29];
u3(0,0,-7.49014056584786e-7) q[21];
u3(0,0,46.2943417558981) q[29];
cx q[20],q[29];
u3(0,0,-92.5886835117962) q[29];
cx q[20],q[29];
u3(0,0,-1.49802811316957e-6) q[20];
u3(0,0,92.5886835117962) q[29];
cx q[19],q[29];
u3(0,0,-185.177367023592) q[29];
cx q[19],q[29];
u3(0,0,-2.99605622633914e-6) q[19];
u3(0,0,185.177367023592) q[29];
cx q[18],q[29];
u3(0,0,-370.354734047185) q[29];
cx q[18],q[29];
u3(0,0,-5.99211245267829e-6) q[18];
u3(0,0,370.354734047185) q[29];
cx q[17],q[29];
u3(0,0,-740.70946809437) q[29];
cx q[17],q[29];
u3(0,0,-1.19842249053566e-5) q[17];
u3(0,0,740.70946809437) q[29];
cx q[16],q[29];
u3(0,0,-1481.41893618874) q[29];
cx q[16],q[29];
u3(0,0,-2.39684498107131e-5) q[16];
u3(0,0,1481.41893618874) q[29];
cx q[15],q[29];
u3(0,0,-2962.83787237748) q[29];
cx q[15],q[29];
u3(0,0,-4.79368996214263e-5) q[15];
u3(0,0,2962.83787237748) q[29];
cx q[14],q[29];
u3(0,0,-5925.67574475496) q[29];
cx q[14],q[29];
u3(0,0,-9.58737992428526e-5) q[14];
u3(0,0,5925.67574475496) q[29];
cx q[13],q[29];
u3(0,0,-11851.3514895099) q[29];
cx q[13],q[29];
u3(0,0,-0.000191747598485705) q[13];
u3(0,0,11851.3514895099) q[29];
cx q[12],q[29];
u3(0,0,-23702.7029790198) q[29];
cx q[12],q[29];
u3(0,0,-0.00038349519697141) q[12];
u3(0,0,23702.7029790198) q[29];
cx q[11],q[29];
u3(0,0,-47405.4059580397) q[29];
cx q[11],q[29];
u3(0,0,-0.000766990393942821) q[11];
u3(0,0,47405.4059580397) q[29];
cx q[10],q[29];
u3(0,0,-94810.8119160793) q[29];
cx q[10],q[29];
u3(0,0,-0.00153398078788564) q[10];
u3(0,0,94810.8119160793) q[29];
cx q[9],q[29];
u3(0,0,-189621.623832159) q[29];
cx q[9],q[29];
u3(0,0,189621.623832159) q[29];
cx q[8],q[29];
u3(0,0,-379243.247664317) q[29];
cx q[8],q[29];
u3(0,0,379243.247664317) q[29];
cx q[7],q[29];
u3(0,0,-758486.495328635) q[29];
cx q[7],q[29];
u3(0,0,758486.495328635) q[29];
cx q[6],q[29];
u3(0,0,-1516972.99065727) q[29];
cx q[6],q[29];
u3(0,0,1516972.99065727) q[29];
cx q[5],q[29];
u3(0,0,-3033945.98131454) q[29];
cx q[5],q[29];
u3(0,0,3033945.98131454) q[29];
cx q[4],q[29];
u3(0,0,-6067891.96262908) q[29];
cx q[4],q[29];
u3(0,0,6067891.96262908) q[29];
cx q[3],q[29];
u3(0,0,-12135783.9252582) q[29];
cx q[3],q[29];
u3(0,0,12135783.9252582) q[29];
cx q[2],q[29];
u3(0,0,-24271567.8505163) q[29];
cx q[2],q[29];
u3(0,0,-pi/8) q[2];
u3(0,0,24271567.8505163) q[29];
cx q[1],q[29];
u3(0,0,-48543135.7010326) q[29];
cx q[1],q[29];
u3(0,0,-pi/4) q[1];
u3(0,0,48543135.7010326) q[29];
cx q[0],q[29];
u3(0,0,-97086271.4020652) q[29];
cx q[0],q[29];
u3(pi/2,0,-pi) q[0];
cx q[0],q[1];
u3(0,0,pi/4) q[1];
