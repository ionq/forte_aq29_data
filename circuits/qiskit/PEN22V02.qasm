...
qreg q[22];
creg c[22];
u3(pi/2,3.141592653286673,-pi) q[0];
u3(pi/2,-1.5707963269464562,-pi) q[1];
u3(pi/2,2.3561944901165646,-pi) q[2];
u3(pi/2,-1.9634954085315106,-pi) q[3];
u3(pi/2,-0.9817477042657554,-pi) q[4];
u3(pi/2,-0.4908738521328777,-pi) q[5];
u3(pi/2,-0.24543692606643885,-pi) q[6];
u3(pi/2,3.0188741905565735,-pi) q[7];
u3(pi/2,-1.6321555583115062,-pi) q[8];
u3(pi/2,2.32551487443404,-pi) q[9];
u3(pi/2,1.1627574372170209,-pi) q[10];
u3(pi/2,-2.5602139349812836,-pi) q[11];
u3(pi/2,-1.2801069674906413,-pi) q[12];
u3(pi/2,-0.6400534837453202,-pi) q[13];
u3(pi/2,-0.32002674187266056,-pi) q[14];
u3(pi/2,-0.16001337093633028,-pi) q[15];
u3(pi/2,-0.08000668546816492,-pi) q[16];
u3(pi/2,-0.04000334273408246,-pi) q[17];
u3(pi/2,-0.020001671367040785,-pi) q[18];
u3(pi/2,-0.010000835683520393,-pi) q[19];
u3(pi/2,3.136592235748033,-pi) q[20];
u3(-pi,-pi/2,pi/2) q[21];
cx q[20],q[21];
u3(0,0,-3.13659223574803) q[21];
cx q[20],q[21];
u3(0,0,-1.49802811316957e-6) q[20];
u3(0,0,3.13659223574803) q[21];
cx q[19],q[21];
u3(0,0,-6.27318447149607) q[21];
cx q[19],q[21];
u3(0,0,-2.99605622633914e-6) q[19];
u3(0,0,6.27318447149607) q[21];
cx q[18],q[21];
u3(0,0,-12.5463689429921) q[21];
cx q[18],q[21];
u3(0,0,-5.99211245267829e-6) q[18];
u3(0,0,12.5463689429921) q[21];
cx q[17],q[21];
u3(0,0,-25.0927378859843) q[21];
cx q[17],q[21];
u3(0,0,-1.19842249053566e-5) q[17];
u3(0,0,25.0927378859843) q[21];
cx q[16],q[21];
u3(0,0,-50.1854757719685) q[21];
cx q[16],q[21];
u3(0,0,-2.39684498107131e-5) q[16];
u3(0,0,50.1854757719685) q[21];
cx q[15],q[21];
u3(0,0,-100.370951543937) q[21];
cx q[15],q[21];
u3(0,0,-4.79368996214263e-5) q[15];
u3(0,0,100.370951543937) q[21];
cx q[14],q[21];
u3(0,0,-200.741903087874) q[21];
cx q[14],q[21];
u3(0,0,-9.58737992428526e-5) q[14];
u3(0,0,200.741903087874) q[21];
cx q[13],q[21];
u3(0,0,-401.483806175748) q[21];
cx q[13],q[21];
u3(0,0,-0.000191747598485705) q[13];
u3(0,0,401.483806175748) q[21];
cx q[12],q[21];
u3(0,0,-802.967612351496) q[21];
cx q[12],q[21];
u3(0,0,-0.00038349519697141) q[12];
u3(0,0,802.967612351496) q[21];
cx q[11],q[21];
u3(0,0,-1605.93522470299) q[21];
cx q[11],q[21];
u3(0,0,-0.000766990393942821) q[11];
u3(0,0,1605.93522470299) q[21];
cx q[10],q[21];
u3(0,0,-3211.87044940599) q[21];
cx q[10],q[21];
u3(0,0,-0.00153398078788564) q[10];
u3(0,0,3211.87044940599) q[21];
cx q[9],q[21];
u3(0,0,-6423.74089881197) q[21];
cx q[9],q[21];
u3(0,0,6423.74089881197) q[21];
cx q[8],q[21];
u3(0,0,-12847.4817976239) q[21];
cx q[8],q[21];
u3(0,0,12847.4817976239) q[21];
cx q[7],q[21];
u3(0,0,-25694.9635952479) q[21];
cx q[7],q[21];
u3(0,0,25694.9635952479) q[21];
cx q[6],q[21];
u3(0,0,-51389.9271904958) q[21];
cx q[6],q[21];
u3(0,0,51389.9271904958) q[21];
cx q[5],q[21];
u3(0,0,-102779.854380992) q[21];
cx q[5],q[21];
u3(0,0,102779.854380992) q[21];
cx q[4],q[21];
u3(0,0,-205559.708761983) q[21];
cx q[4],q[21];
u3(0,0,205559.708761983) q[21];
cx q[3],q[21];
u3(0,0,-411119.417523966) q[21];
cx q[3],q[21];
u3(0,0,411119.417523966) q[21];
cx q[2],q[21];
u3(0,0,-822238.835047932) q[21];
cx q[2],q[21];
u3(0,0,-pi/8) q[2];
u3(0,0,822238.835047932) q[21];
cx q[1],q[21];
u3(0,0,-1644477.67009586) q[21];
cx q[1],q[21];
u3(0,0,-pi/4) q[1];
u3(0,0,1644477.67009586) q[21];
cx q[0],q[21];
u3(0,0,-3288955.34019173) q[21];
cx q[0],q[21];
u3(pi/2,0,-pi) q[0];
cx q[0],q[1];
u3(0,0,pi/4) q[1];
