...
qreg q[21];
creg c[21];
u3(pi/2,3.1415926535831096,-pi) q[0];
u3(pi/2,-1.5707963267982379,-pi) q[1];
u3(pi/2,2.356194490190674,-pi) q[2];
u3(pi/2,-5*pi/8,-pi) q[3];
u3(pi/2,11*pi/16,-pi) q[4];
u3(pi/2,-2.0616701789185106,-pi) q[5];
u3(pi/2,2.1107575641305374,-pi) q[6];
u3(pi/2,1.0553787820652687,-pi) q[7];
u3(pi/2,0.5276893910326343,-pi) q[8];
u3(pi/2,0.2638446955163172,-pi) q[9];
u3(pi/2,0.1319223477581586,-pi) q[10];
u3(pi/2,0.06596117387907974,-pi) q[11];
u3(pi/2,-3.1086120666502532,-pi) q[12];
u3(pi/2,1.587286620264667,-pi) q[13];
u3(pi/2,0.7936433101323335,-pi) q[14];
u3(pi/2,-2.7447709985236264,-pi) q[15];
u3(pi/2,1.7692071543279795,-pi) q[16];
u3(pi/2,0.8846035771639897,-pi) q[17];
u3(pi/2,0.44230178858199487,-pi) q[18];
u3(pi/2,0.22115089429099744,-pi) q[19];
u3(-pi,-pi/2,pi/2) q[20];
cx q[19],q[20];
u3(0,0,-0.221150894290997) q[20];
cx q[19],q[20];
u3(0,0,-2.99605622633914e-6) q[19];
u3(0,0,0.221150894290997) q[20];
cx q[18],q[20];
u3(0,0,-0.442301788581995) q[20];
cx q[18],q[20];
u3(0,0,-5.99211245267829e-6) q[18];
u3(0,0,0.442301788581995) q[20];
cx q[17],q[20];
u3(0,0,-0.88460357716399) q[20];
cx q[17],q[20];
u3(0,0,-1.19842249053566e-5) q[17];
u3(0,0,0.88460357716399) q[20];
cx q[16],q[20];
u3(0,0,-1.76920715432798) q[20];
cx q[16],q[20];
u3(0,0,-2.39684498107131e-5) q[16];
u3(0,0,1.76920715432798) q[20];
cx q[15],q[20];
u3(0,0,-3.53841430865596) q[20];
cx q[15],q[20];
u3(0,0,-4.79368996214263e-5) q[15];
u3(0,0,3.53841430865596) q[20];
cx q[14],q[20];
u3(0,0,-7.07682861731192) q[20];
cx q[14],q[20];
u3(0,0,-9.58737992428526e-5) q[14];
u3(0,0,7.07682861731192) q[20];
cx q[13],q[20];
u3(0,0,-14.1536572346238) q[20];
cx q[13],q[20];
u3(0,0,-0.000191747598485705) q[13];
u3(0,0,14.1536572346238) q[20];
cx q[12],q[20];
u3(0,0,-28.3073144692477) q[20];
cx q[12],q[20];
u3(0,0,-0.00038349519697141) q[12];
u3(0,0,28.3073144692477) q[20];
cx q[11],q[20];
u3(0,0,-56.6146289384954) q[20];
cx q[11],q[20];
u3(0,0,-0.000766990393942821) q[11];
u3(0,0,56.6146289384954) q[20];
cx q[10],q[20];
u3(0,0,-113.229257876991) q[20];
cx q[10],q[20];
u3(0,0,-0.00153398078788564) q[10];
u3(0,0,113.229257876991) q[20];
cx q[9],q[20];
u3(0,0,-226.458515753981) q[20];
cx q[9],q[20];
u3(0,0,226.458515753981) q[20];
cx q[8],q[20];
u3(0,0,-452.917031507963) q[20];
cx q[8],q[20];
u3(0,0,452.917031507963) q[20];
cx q[7],q[20];
u3(0,0,-905.834063015926) q[20];
cx q[7],q[20];
u3(0,0,905.834063015926) q[20];
cx q[6],q[20];
u3(0,0,-1811.66812603185) q[20];
cx q[6],q[20];
u3(0,0,1811.66812603185) q[20];
cx q[5],q[20];
u3(0,0,-3623.3362520637) q[20];
cx q[5],q[20];
u3(0,0,3623.3362520637) q[20];
cx q[4],q[20];
u3(0,0,-7246.67250412741) q[20];
cx q[4],q[20];
u3(0,0,7246.67250412741) q[20];
cx q[3],q[20];
u3(0,0,-14493.3450082548) q[20];
cx q[3],q[20];
u3(0,0,14493.3450082548) q[20];
cx q[2],q[20];
u3(0,0,-28986.6900165096) q[20];
cx q[2],q[20];
u3(0,0,-pi/8) q[2];
u3(0,0,28986.6900165096) q[20];
cx q[1],q[20];
u3(0,0,-57973.3800330192) q[20];
cx q[1],q[20];
u3(0,0,-pi/4) q[1];
u3(0,0,57973.3800330192) q[20];
cx q[0],q[20];
u3(0,0,-115946.760066038) q[20];
cx q[0],q[20];
u3(pi/2,0,-pi) q[0];
cx q[0],q[1];
u3(0,0,pi/4) q[1];
