...
qreg q[24];
creg c[24];
u3(pi/2,3.141592653564328,-pi) q[0];
u3(pi/2,1.5707963267821645,-pi) q[1];
u3(pi/2,-2.3561944901987104,-pi) q[2];
u3(pi/2,1.963495408490438,-pi) q[3];
u3(pi/2,-2.159844949344574,-pi) q[4];
u3(pi/2,2.061670178917506,-pi) q[5];
u3(pi/2,1.030835089458753,-pi) q[6];
u3(pi/2,-2.6261751088604166,-pi) q[7];
u3(pi/2,-1.313087554430208,-pi) q[8];
u3(pi/2,-0.6565437772151039,-pi) q[9];
u3(pi/2,-0.32827188860755196,-pi) q[10];
u3(pi/2,-0.16413594430377554,-pi) q[11];
u3(pi/2,-0.08206797215188821,-pi) q[12];
u3(pi/2,3.10055866751385,-pi) q[13];
u3(pi/2,-1.5913133198328686,-pi) q[14];
u3(pi/2,-0.7956566599164345,-pi) q[15];
u3(pi/2,-0.39782832995821726,-pi) q[16];
u3(pi/2,2.942678488610685,-pi) q[17];
u3(pi/2,1.4713392443053426,-pi) q[18];
u3(pi/2,-2.405923031437122,-pi) q[19];
u3(pi/2,1.9386311378712326,-pi) q[20];
u3(pi/2,0.9693155689356168,-pi) q[21];
u3(pi/2,0.4846577844678084,-pi) q[22];
u3(-pi,-pi/2,pi/2) q[23];
cx q[22],q[23];
u3(0,0,-0.484657784467808) q[23];
cx q[22],q[23];
u3(0,0,-3.74507028292393e-7) q[22];
u3(0,0,0.484657784467808) q[23];
cx q[21],q[23];
u3(0,0,-0.969315568935616) q[23];
cx q[21],q[23];
u3(0,0,-7.49014056584786e-7) q[21];
u3(0,0,0.969315568935616) q[23];
cx q[20],q[23];
u3(0,0,-1.93863113787123) q[23];
cx q[20],q[23];
u3(0,0,-1.49802811316957e-6) q[20];
u3(0,0,1.93863113787123) q[23];
cx q[19],q[23];
u3(0,0,-3.87726227574246) q[23];
cx q[19],q[23];
u3(0,0,-2.99605622633914e-6) q[19];
u3(0,0,3.87726227574246) q[23];
cx q[18],q[23];
u3(0,0,-7.75452455148493) q[23];
cx q[18],q[23];
u3(0,0,-5.99211245267829e-6) q[18];
u3(0,0,7.75452455148493) q[23];
cx q[17],q[23];
u3(0,0,-15.5090491029699) q[23];
cx q[17],q[23];
u3(0,0,-1.19842249053566e-5) q[17];
u3(0,0,15.5090491029699) q[23];
cx q[16],q[23];
u3(0,0,-31.0180982059397) q[23];
cx q[16],q[23];
u3(0,0,-2.39684498107131e-5) q[16];
u3(0,0,31.0180982059397) q[23];
cx q[15],q[23];
u3(0,0,-62.0361964118794) q[23];
cx q[15],q[23];
u3(0,0,-4.79368996214263e-5) q[15];
u3(0,0,62.0361964118794) q[23];
cx q[14],q[23];
u3(0,0,-124.072392823759) q[23];
cx q[14],q[23];
u3(0,0,-9.58737992428526e-5) q[14];
u3(0,0,124.072392823759) q[23];
cx q[13],q[23];
u3(0,0,-248.144785647518) q[23];
cx q[13],q[23];
u3(0,0,-0.000191747598485705) q[13];
u3(0,0,248.144785647518) q[23];
cx q[12],q[23];
u3(0,0,-496.289571295035) q[23];
cx q[12],q[23];
u3(0,0,-0.00038349519697141) q[12];
u3(0,0,496.289571295035) q[23];
cx q[11],q[23];
u3(0,0,-992.579142590071) q[23];
cx q[11],q[23];
u3(0,0,-0.000766990393942821) q[11];
u3(0,0,992.579142590071) q[23];
cx q[10],q[23];
u3(0,0,-1985.15828518014) q[23];
cx q[10],q[23];
u3(0,0,-0.00153398078788564) q[10];
u3(0,0,1985.15828518014) q[23];
cx q[9],q[23];
u3(0,0,-3970.31657036028) q[23];
cx q[9],q[23];
u3(0,0,3970.31657036028) q[23];
cx q[8],q[23];
u3(0,0,-7940.63314072057) q[23];
cx q[8],q[23];
u3(0,0,7940.63314072057) q[23];
cx q[7],q[23];
u3(0,0,-15881.2662814411) q[23];
cx q[7],q[23];
u3(0,0,15881.2662814411) q[23];
cx q[6],q[23];
u3(0,0,-31762.5325628823) q[23];
cx q[6],q[23];
u3(0,0,31762.5325628823) q[23];
cx q[5],q[23];
u3(0,0,-63525.0651257645) q[23];
cx q[5],q[23];
u3(0,0,63525.0651257645) q[23];
cx q[4],q[23];
u3(0,0,-127050.130251529) q[23];
cx q[4],q[23];
u3(0,0,127050.130251529) q[23];
cx q[3],q[23];
u3(0,0,-254100.260503058) q[23];
cx q[3],q[23];
u3(0,0,254100.260503058) q[23];
cx q[2],q[23];
u3(0,0,-508200.521006116) q[23];
cx q[2],q[23];
u3(0,0,-pi/8) q[2];
u3(0,0,508200.521006116) q[23];
cx q[1],q[23];
u3(0,0,-1016401.04201223) q[23];
cx q[1],q[23];
u3(0,0,-pi/4) q[1];
u3(0,0,1016401.04201223) q[23];
cx q[0],q[23];
u3(0,0,-2032802.08402447) q[23];
cx q[0],q[23];
u3(pi/2,0,-pi) q[0];
cx q[0],q[1];
u3(0,0,pi/4) q[1];
