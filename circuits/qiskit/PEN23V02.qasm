...
u3(pi/2,1.8653206380689618,-pi) q[5];
u3(pi/2,0.9326603190344809,-pi) q[6];
u3(pi/2,0.46633015951724044,-pi) q[7];
u3(pi/2,-2.908427573831173,-pi) q[8];
u3(pi/2,-1.4542137869155867,-pi) q[9];
u3(pi/2,-0.7271068934577931,-pi) q[10];
u3(pi/2,2.778039206860896,-pi) q[11];
u3(pi/2,-1.7525730501593448,-pi) q[12];
u3(pi/2,-0.8762865250796725,-pi) q[13];
u3(pi/2,2.703449391049957,-pi) q[14];
u3(pi/2,-1.7898679580648142,-pi) q[15];
u3(pi/2,-0.8949339790324076,-pi) q[16];
u3(pi/2,2.6941256640735896,-pi) q[17];
u3(pi/2,1.3470628320367952,-pi) q[18];
u3(pi/2,0.6735314160183972,-pi) q[19];
u3(pi/2,0.3367657080091986,-pi) q[20];
u3(pi/2,0.16838285400459974,-pi) q[21];
u3(-pi,-pi/2,pi/2) q[22];
cx q[21],q[22];
u3(0,0,-0.168382854004599) q[22];
cx q[21],q[22];
u3(0,0,-7.49014056584786e-7) q[21];
u3(0,0,0.168382854004599) q[22];
cx q[20],q[22];
u3(0,0,-0.336765708009199) q[22];
cx q[20],q[22];
u3(0,0,-1.49802811316957e-6) q[20];
u3(0,0,0.336765708009199) q[22];
cx q[19],q[22];
u3(0,0,-0.673531416018397) q[22];
cx q[19],q[22];
u3(0,0,-2.99605622633914e-6) q[19];
u3(0,0,0.673531416018397) q[22];
cx q[18],q[22];
u3(0,0,-1.34706283203679) q[22];
cx q[18],q[22];
u3(0,0,-5.99211245267829e-6) q[18];
u3(0,0,1.34706283203679) q[22];
cx q[17],q[22];
u3(0,0,-2.69412566407359) q[22];
cx q[17],q[22];
u3(0,0,-1.19842249053566e-5) q[17];
u3(0,0,2.69412566407359) q[22];
cx q[16],q[22];
u3(0,0,-5.38825132814718) q[22];
cx q[16],q[22];
u3(0,0,-2.39684498107131e-5) q[16];
u3(0,0,5.38825132814718) q[22];
cx q[15],q[22];
u3(0,0,-10.7765026562944) q[22];
cx q[15],q[22];
u3(0,0,-4.79368996214263e-5) q[15];
u3(0,0,10.7765026562944) q[22];
cx q[14],q[22];
u3(0,0,-21.5530053125887) q[22];
cx q[14],q[22];
u3(0,0,-9.58737992428526e-5) q[14];
u3(0,0,21.5530053125887) q[22];
cx q[13],q[22];
u3(0,0,-43.1060106251774) q[22];
cx q[13],q[22];
u3(0,0,-0.000191747598485705) q[13];
u3(0,0,43.1060106251774) q[22];
cx q[12],q[22];
u3(0,0,-86.2120212503549) q[22];
cx q[12],q[22];
u3(0,0,-0.00038349519697141) q[12];
u3(0,0,86.2120212503549) q[22];
cx q[11],q[22];
u3(0,0,-172.42404250071) q[22];
cx q[11],q[22];
u3(0,0,-0.000766990393942821) q[11];
u3(0,0,172.42404250071) q[22];
cx q[10],q[22];
u3(0,0,-344.848085001419) q[22];
cx q[10],q[22];
u3(0,0,-0.00153398078788564) q[10];
u3(0,0,344.848085001419) q[22];
cx q[9],q[22];
u3(0,0,-689.696170002839) q[22];
cx q[9],q[22];
u3(0,0,689.696170002839) q[22];
cx q[8],q[22];
u3(0,0,-1379.39234000568) q[22];
cx q[8],q[22];
u3(0,0,1379.39234000568) q[22];
cx q[7],q[22];
u3(0,0,-2758.78468001136) q[22];
cx q[7],q[22];
u3(0,0,2758.78468001136) q[22];
cx q[6],q[22];
u3(0,0,-5517.56936002271) q[22];
cx q[6],q[22];
u3(0,0,5517.56936002271) q[22];
cx q[5],q[22];
u3(0,0,-11035.1387200454) q[22];
cx q[5],q[22];
u3(0,0,11035.1387200454) q[22];
cx q[4],q[22];
u3(0,0,-22070.2774400908) q[22];
cx q[4],q[22];
u3(0,0,22070.2774400908) q[22];
cx q[3],q[22];
u3(0,0,-44140.5548801817) q[22];
cx q[3],q[22];
u3(0,0,44140.5548801817) q[22];
cx q[2],q[22];
u3(0,0,-88281.1097603634) q[22];
cx q[2],q[22];
u3(0,0,-pi/8) q[2];
u3(0,0,88281.1097603634) q[22];
cx q[1],q[22];
u3(0,0,-176562.219520727) q[22];
cx q[1],q[22];
u3(0,0,-pi/4) q[1];
u3(0,0,176562.219520727) q[22];
cx q[0],q[22];
u3(0,0,-353124.439041454) q[22];
cx q[0],q[22];
u3(pi/2,0,-pi) q[0];
cx q[0],q[1];
u3(0,0,pi/4) q[1];
