...
qreg q[27];
creg c[27];
u3(pi/2,2.8483615466257106e-10,-pi) q[0];
u3(pi/2,-3.1415926534473746,-pi) q[1];
u3(pi/2,-1.5707963267236875,-pi) q[2];
u3(pi/2,2.3561944902279492,-pi) q[3];
u3(pi/2,-1.9634954084758185,-pi) q[4];
u3(pi/2,2.159844949351884,-pi) q[5];
u3(pi/2,1.079922474675942,-pi) q[6];
u3(pi/2,-2.6016314162518226,-pi) q[7];
u3(pi/2,-1.3008157081259109,-pi) q[8];
u3(pi/2,-0.6504078540629559,-pi) q[9];
u3(pi/2,-0.3252039270314775,-pi) q[10];
u3(pi/2,2.9789906900740544,-pi) q[11];
u3(pi/2,-1.6520973085527657,-pi) q[12];
u3(pi/2,2.3155439993134106,-pi) q[13];
u3(pi/2,-1.9838206539330878,-pi) q[14];
u3(pi/2,2.1496823266232497,-pi) q[15];
u3(pi/2,1.0748411633116248,-pi) q[16];
u3(pi/2,-2.6041720719339807,-pi) q[17];
u3(pi/2,-1.3020860359669904,-pi) q[18];
u3(pi/2,2.490549635606298,-pi) q[19];
u3(pi/2,-1.8963178357866441,-pi) q[20];
u3(pi/2,-0.9481589178933225,-pi) q[21];
u3(pi/2,-0.4740794589466608,-pi) q[22];
u3(pi/2,2.904552924116463,-pi) q[23];
u3(pi/2,1.4522764620582311,-pi) q[24];
u3(pi/2,0.726138231029116,-pi) q[25];
u3(-pi,-pi/2,pi/2) q[26];
cx q[25],q[26];
u3(0,0,-0.726138231029116) q[26];
cx q[25],q[26];
u3(0,0,-4.68133785365491e-8) q[25];
u3(0,0,0.726138231029116) q[26];
cx q[24],q[26];
u3(0,0,-1.45227646205823) q[26];
cx q[24],q[26];
u3(0,0,-9.36267570730982e-8) q[24];
u3(0,0,1.45227646205823) q[26];
cx q[23],q[26];
u3(0,0,-2.90455292411646) q[26];
cx q[23],q[26];
u3(0,0,-1.87253514146196e-7) q[23];
u3(0,0,2.90455292411646) q[26];
cx q[22],q[26];
u3(0,0,-5.80910584823293) q[26];
cx q[22],q[26];
u3(0,0,-3.74507028292393e-7) q[22];
u3(0,0,5.80910584823293) q[26];
cx q[21],q[26];
u3(0,0,-11.6182116964659) q[26];
cx q[21],q[26];
u3(0,0,-7.49014056584786e-7) q[21];
u3(0,0,11.6182116964659) q[26];
cx q[20],q[26];
u3(0,0,-23.2364233929317) q[26];
cx q[20],q[26];
u3(0,0,-1.49802811316957e-6) q[20];
u3(0,0,23.2364233929317) q[26];
cx q[19],q[26];
u3(0,0,-46.4728467858634) q[26];
cx q[19],q[26];
u3(0,0,-2.99605622633914e-6) q[19];
u3(0,0,46.4728467858634) q[26];
cx q[18],q[26];
u3(0,0,-92.9456935717268) q[26];
cx q[18],q[26];
u3(0,0,-5.99211245267829e-6) q[18];
u3(0,0,92.9456935717268) q[26];
cx q[17],q[26];
u3(0,0,-185.891387143454) q[26];
cx q[17],q[26];
u3(0,0,-1.19842249053566e-5) q[17];
u3(0,0,185.891387143454) q[26];
cx q[16],q[26];
u3(0,0,-371.782774286907) q[26];
cx q[16],q[26];
u3(0,0,-2.39684498107131e-5) q[16];
u3(0,0,371.782774286907) q[26];
cx q[15],q[26];
u3(0,0,-743.565548573814) q[26];
cx q[15],q[26];
u3(0,0,-4.79368996214263e-5) q[15];
u3(0,0,743.565548573814) q[26];
cx q[14],q[26];
u3(0,0,-1487.13109714763) q[26];
cx q[14],q[26];
u3(0,0,-9.58737992428526e-5) q[14];
u3(0,0,1487.13109714763) q[26];
cx q[13],q[26];
u3(0,0,-2974.26219429526) q[26];
cx q[13],q[26];
u3(0,0,-0.000191747598485705) q[13];
u3(0,0,2974.26219429526) q[26];
cx q[12],q[26];
u3(0,0,-5948.52438859052) q[26];
cx q[12],q[26];
u3(0,0,-0.00038349519697141) q[12];
u3(0,0,5948.52438859052) q[26];
cx q[11],q[26];
u3(0,0,-11897.048777181) q[26];
cx q[11],q[26];
u3(0,0,-0.000766990393942821) q[11];
u3(0,0,11897.048777181) q[26];
cx q[10],q[26];
u3(0,0,-23794.0975543621) q[26];
cx q[10],q[26];
u3(0,0,-0.00153398078788564) q[10];
u3(0,0,23794.0975543621) q[26];
cx q[9],q[26];
u3(0,0,-47588.1951087241) q[26];
cx q[9],q[26];
u3(0,0,47588.1951087241) q[26];
cx q[8],q[26];
u3(0,0,-95176.3902174483) q[26];
cx q[8],q[26];
u3(0,0,95176.3902174483) q[26];
cx q[7],q[26];
u3(0,0,-190352.780434897) q[26];
cx q[7],q[26];
u3(0,0,190352.780434897) q[26];
cx q[6],q[26];
u3(0,0,-380705.560869793) q[26];
cx q[6],q[26];
u3(0,0,380705.560869793) q[26];
cx q[5],q[26];
u3(0,0,-761411.121739586) q[26];
cx q[5],q[26];
u3(0,0,761411.121739586) q[26];
cx q[4],q[26];
u3(0,0,-1522822.24347917) q[26];
cx q[4],q[26];
u3(0,0,1522822.24347917) q[26];
cx q[3],q[26];
u3(0,0,-3045644.48695834) q[26];
cx q[3],q[26];
u3(0,0,3045644.48695834) q[26];
cx q[2],q[26];
u3(0,0,-6091288.97391669) q[26];
cx q[2],q[26];
u3(0,0,-pi/8) q[2];
u3(0,0,6091288.97391669) q[26];
cx q[1],q[26];
u3(0,0,-12182577.9478334) q[26];
cx q[1],q[26];
u3(0,0,-pi/4) q[1];
u3(0,0,12182577.9478334) q[26];
cx q[0],q[26];
u3(0,0,-24365155.8956668) q[26];
cx q[0],q[26];
u3(pi/2,0,-pi) q[0];
cx q[0],q[1];
u3(0,0,pi/4) q[1];
