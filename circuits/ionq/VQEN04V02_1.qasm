...
rzz(-pi/2) q[0],q[1];
u3(pi/2,0,0) q[0];
u3(pi/2,4.041973108108627,-4.041973108108627) q[1];
u3(pi/2,0.23059290077349084,-0.23059290077349084) q[1];
rzz(pi/2) q[0],q[1];
u3(pi/2,0.2965663464988765,-0.2965663464988765) q[2];
u3(pi/2,5.008955326883567,-5.008955326883567) q[3];
rzz(pi/2) q[2],q[3];
u3(pi/2,3.4381590000886697,-3.4381590000886697) q[3];
rzz(pi/2) q[2],q[3];
u3(pi/2,pi,-pi) q[0];
rzz(-pi/2) q[2],q[0];
u3(pi/2,3*pi/2,-3*pi/2) q[0];
u3(pi/2,1.8013892275683874,-1.8013892275683874) q[1];
rzz(-pi/2) q[0],q[1];
...
u3(pi/2,3*pi/2,-3*pi/2) q[0];
rzz(pi/2) q[0],q[1];
u3(pi/2,3.127769645913998,-3.127769645913998) q[1];
u3(pi/2,6.024946391054505,-6.024946391054505) q[1];
rzz(pi/2) q[0],q[1];
